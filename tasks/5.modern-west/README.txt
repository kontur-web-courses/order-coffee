...
Заметь, что используя современный синтаксис class можно наследоваться от типов,
определенных с использованием старого синтаксиса.
...
- Переопредели в классе Creature реализацию getDescriptions на новую.
  ...
  Одна из getDescriptions в Card.
  ...
  Вторая — из функции getCreatureDescription, которая определена в index.js.
